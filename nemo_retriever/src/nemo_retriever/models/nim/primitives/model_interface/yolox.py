...
class YoloxPageElementsModelInterface(YoloxModelInterfaceBase):
    ...
    def _infer_local_nemotron_page_elements_v3(self, data: Dict[str, Any], **kwargs) -> List[Dict[str, Any]]:
        ...
        # Reuse the existing `nemo_retriever.api` postprocessing + coord transform.
    ...
    def postprocess_annotations(self, annotation_dicts, final_score=None, **kwargs):
        ...
        if annotation_dicts and running_v3:
            ...
            # Table/chart expansion is "business logic" specific to `nemo_retriever.api`
        ...
        # This final thresholding is "business logic" specific to `nemo_retriever.api`
        for annotation_dict in annotation_dicts:
            new_dict = {}
            if running_v3:
...
class YoloxGraphicElementsModelInterface(YoloxModelInterfaceBase):
    ...
    def _get_local_nemotron_graphic_elements_v1(cls, *, device: Optional[str] = None):
        ...
        chart extraction can work in environments where only `nemo_retriever.api` + the
    ...
    def _infer_local_nemotron_graphic_elements_v1(self, data: Dict[str, Any], **kwargs) -> List[Dict[str, Any]]:
        ...
        # Reuse existing `nemo_retriever.api` postprocessing + coord transform to pixel-space box dict.
    ...
    def postprocess_annotations(self, annotation_dicts, **kwargs):
        ...
        # bbox extraction: additional postprocessing specific to `nemo_retriever.api`
